...
1. Eğer proje Flutter ile oluşturulmadıysa, terminalde proje kökünde şu komutu çalıştırarak eksik platform dosyalarını oluşturabilirsiniz:
...
3. Uygulamayı çalıştırın (bağlı bir cihaz veya emulator gereklidir):
